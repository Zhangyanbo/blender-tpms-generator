...
Subdivisions**, then press **Generate TPMS**. The advanced Harmonic Solver
and Quadrature Order defaults normally need no adjustment.
...
寸、晶胞数量和 **Quad Subdivisions**，点击 **Generate TPMS**。Harmonic
Solver 和 Quadrature Order 通常保持默认即可。
